...
---@field colormap nil|death-metal.Theme.Terminal mapping to terminal colors

---@class death-metal.Theme.Terminal
---@field black string
---@field grey string
---@field red string
---@field orange string
...
for key, theme in pairs(M.themes) do
	M[key] = require("death-metal.palette." .. theme)
end
...
M.get = function(theme, variant)
	if variant == "light" then
		return require("death-metal.palette.day").get()
	else
